...
def get_args_parser():
    ...
    parser.add_argument('--num_queries', default=200, type=int,
                        help="Number of query slots which equals to number of classes")    parser.add_argument('--k_queries_per_class', default=1, type=int,
    ...
    parser.add_argument('--query_aggregation', default='max', type=str, choices=['max', 'mean', 'sum'],
                        help='How to aggregate K queries per class for prediction')    parser.add_argument('--pre_norm', action='store_true')
